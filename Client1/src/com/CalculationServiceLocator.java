...
public class CalculationServiceLocator extends org.apache.axis.client.Service implements com.CalculationService {
    ...
    private java.lang.String Calculation_address = "http://localhost:8086/Demo1/services/Calculation";
    ...
    public com.Calculation getCalculation() throws javax.xml.rpc.ServiceException {
    ...
    public com.Calculation getCalculation(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.CalculationSoapBindingStub _stub = new com.CalculationSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.Calculation.class.isAssignableFrom(serviceEndpointInterface)) {
                com.CalculationSoapBindingStub _stub = new com.CalculationSoapBindingStub(new java.net.URL(Calculation_address), this);
                _stub.setPortName(getCalculationWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://com", "CalculationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://com", "Calculation"));
        }
